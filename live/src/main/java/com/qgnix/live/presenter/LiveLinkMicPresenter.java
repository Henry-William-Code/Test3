...
import com.qgnix.live.interfaces.ILiveLinkMicViewHolder;
import com.qgnix.live.interfaces.LivePushListener;
import com.qgnix.live.socket.SocketClient;
import com.qgnix.live.socket.SocketLinkMicUtil;
import com.qgnix.live.views.AbsLiveLinkMicPlayViewHolder;
import com.qgnix.live.views.AbsLiveLinkMicPushViewHolder;
import com.qgnix.live.views.LiveLinkMicPlayTxViewHolder;
import com.qgnix.live.views.LiveLinkMicPushTxViewHolder;
...
//            btnLinkMic.setVisibility(View.VISIBLE);
            ...
            mLinkMicIcon = (ImageView) root.findViewById(R.id.link_mic_icon);
...
//                }
    ...
    private void anchorAcceptLinkMicApply() {
        if (((LiveAnchorActivity) mContext).isBgmPlaying()) {
            DialogUtil.showSimpleDialog(mContext, WordUtil.getString(R.string.link_mic_close_bgm), new DialogUtil.SimpleCallback() {
                @Override
