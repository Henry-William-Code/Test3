...
import com.qgnix.live.bean.LiveFunctionBean;
...
public class LiveFunctionAdapter extends RecyclerView.Adapter<LiveFunctionAdapter.Vh> {
    ...
    public LiveFunctionAdapter(Context context, boolean hasGame) {
        ...
        mList.add(new LiveFunctionBean(Constants.LIVE_FUNC_VIBRATING_EGG, R.mipmap.icon_live_vibrating_egg, R.string.open_vibrator));
