...
public class LivePlayTxViewHolder extends LiveRoomPlayViewHolder implements ITXLivePlayListener {
    ...
    public void init() {
        ...
        mPlayer.setRenderMode(config.renderMode);
        mPlayer.setRenderRotation(TXLiveConstants.RENDER_ROTATION_PORTRAIT);
        mPlayer.enableHardwareDecode(config.enableHWAcceleration);
        ...
        try {
            ...
            switch (e) {
                ...
                case TXLiveConstants.PLAY_EVT_PLAY_END://播放结束
                    replay();
                    break;
                case TXLiveConstants.PLAY_ERR_NET_DISCONNECT://网络断开，拉流失败
                    if (mContext instanceof LiveAudienceActivity) {
                        ((LiveAudienceActivity) mContext).liveDisconnect();
                    }
                    break;
    ...
    public void onNetStatus(Bundle bundle) {
        //L.e(TAG, "流---onNetStatus----->" + bundle.toString());
    }
