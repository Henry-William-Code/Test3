...
import com.qgnix.live.adapter.GuardRightAdapter;
import com.qgnix.live.bean.GuardBuyBean;
import com.qgnix.live.bean.GuardRightBean;
...
public class LiveGuardBuyDialogFragment extends AbsDialogFragment implements View.OnClickListener {
    ...
    public void onActivityCreated( Bundle savedInstanceState) {
        ...
        mPrices[0] = mRootView.findViewById(R.id.price_1);
        mPrices[1] = mRootView.findViewById(R.id.price_2);
        mPrices[2] = mRootView.findViewById(R.id.price_3);
    ...
    private void buyGuard() {
        ...
        DialogUtil.showSimpleDialog(mContext,
                String.format(WordUtil.getString(R.string.guard_buy_tip_3), mTargetBuyBean.getCoin(), mCoinName, mTargetBuyBean.getName()),
