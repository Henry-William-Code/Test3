...
//import com.qgnix.im.utils.ImMessageUtil;
import com.qgnix.live.R;
import com.qgnix.live.activity.LiveActivity;
import com.qgnix.live.activity.LiveReportActivity;
import com.qgnix.live.bean.ImpressBean;
import com.qgnix.live.custom.MyTextView;
...
public class LiveUserDialogFragment extends AbsDialogFragment implements View.OnClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (bottomView != null) {
            mBtnFollow = bottomView.findViewById(R.id.btn_follow);
            if (mBtnFollow != null) {
    ...
    private void showData(String data) {
        ...
        mVotes.setText(LiveTextRender.renderLiveUserDialogData(obj.getString("votestotal")));
