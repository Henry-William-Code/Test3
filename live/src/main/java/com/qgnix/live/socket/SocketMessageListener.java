...
public interface SocketMessageListener extends SocketCpMsgListener{
     ...
     * 直播间 中奖
     */
    void onWinning(List<LiveChatBean> bean);

    /**
     * 直播间 跟投
     */
    void onFollowUp(LiveChatBean bean);
     ...
     * 直播间  服务端关闭直播间
     */
    void onSuperCloseLive(String msg);
...
/***********************以下是游戏*********************************/
     ...
     * @param datas
     */
    void onUserList(List<LiveUserGiftBean> datas);
