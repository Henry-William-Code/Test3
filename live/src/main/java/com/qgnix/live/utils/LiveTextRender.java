...
import com.qgnix.common.custom.VerticalImageSpan;
...
public class LiveTextRender {
            ...
            public void onLoadSuccess(Drawable drawable) {
                if (textView != null) {
                    ...
                    if (bean.isAnchor()) {
                        ...
                        if (levelBean.getColor().contains("#")) {
     ...
     * 渲染直播间用户弹窗数据
     */
    public static CharSequence renderLiveUserDialogData(String numStr) {
        numStr = TextUtils.isEmpty(numStr) ? "0" : (numStr.substring(0, numStr.indexOf(".")));
        return renderLiveUserDialogData(Long.parseLong(numStr));
    }
}
