package com.qgnix.main.ixxo.view.shimmer;
...
public class ShimmerViewHelper {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray a = view.getContext().obtainStyledAttributes(attributeSet, null, 0, 0);
            if (a != null) {
                try {
                    reflectionColor = a.getColor(0, DEFAULT_REFLECTION_COLOR);
                } catch (Exception e) {
