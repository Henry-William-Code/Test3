...
import com.qgnix.main.ixxo.bean.Level;
import com.qgnix.main.ixxo.bean.ViewBean;
import com.qgnix.main.ixxo.maze.MusicService;
import com.qgnix.main.ixxo.util.Constant;
import com.qgnix.main.ixxo.util.GDTAdUtil;
import com.qgnix.main.ixxo.util.MazeAnimationUtils;
import com.qgnix.main.ixxo.util.PixelUtil;
import com.qgnix.main.ixxo.util.SharedpreferencesUtils;
import com.qgnix.main.ixxo.util.T;
import com.qgnix.main.ixxo.util.UtilTools;
import com.qgnix.main.ixxo.view.CircleFlashView;
import com.qgnix.main.ixxo.view.MyView;
import com.qgnix.main.ixxo.view.SexangleImageViews;
import com.qgnix.main.ixxo.view.SexangleImageViews.OnSexangleImageClickListener;
import com.qgnix.main.ixxo.view.SexangleViewGroup;
import com.qgnix.main.ixxo.view.SixBoxMenuViewGroup;
import com.qgnix.main.ixxo.view.SixBoxMenuViews;
import com.qgnix.main.ixxo.view.SixangleBoxViewGroup;
import com.qgnix.main.ixxo.view.SixangleBoxViews;
import com.qgnix.main.ixxo.view.SixangleBoxViews.OnSexangleBoxClickListener;
import com.qgnix.main.ixxo.view.shimmer.Shimmer;
import com.qgnix.main.ixxo.view.shimmer.ShimmerTextView;
...
public class MazeActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fl_main =  findViewById(0);
        fl_success = findViewById(0);
        btn_back = findViewById(0);
        showMap = findViewById(0);
        showMenus = findViewById(0);
        //tv = (ShimmerTextView) findViewById(R.id.shimmer_tv);
        shimmer_team =  findViewById(0);
        //mSplashView = findViewById(R.id.splash_view);
        sexangleViewGroup =  findViewById(0);
        menus = findViewById(0);
        roomGroup1 = findViewById(0);
        roomGroup2 = findViewById(0);
        tv_step =   findViewById(0);
        iv_key =  findViewById(0);
        tv_keys =   findViewById(0);
        ...
        adUtil.initBanner((ViewGroup) findViewById(0));
        adUtil.addListener(findViewById(0));
        adUtil.addListener(findViewById(0));
        adUtil.addListener(findViewById(0));
    ...
    private void initDatas() {
        step_str = getResources().getString(0);
        noWay = getResources().getString(0);
        need_collect_key = getResources().getString(0);
        loc_w = getResources().getDimensionPixelSize(0);
    }
    ...
    private void InitSounds() {
        ...
        soundPoolMap.put(1, mSound.load(this, 0, 1));
        soundPoolMap.put(2, mSound.load(this, 0, 1));
        soundPoolMap.put(3, mSound.load(this, 0, 1));
        soundPoolMap.put(4, mSound.load(this, 0, 1));
        soundPoolMap.put(5, mSound.load(this, 0, 1));
        soundPoolMap.put(6, mSound.load(this, 0, 1));
        // 可以在后面继续put音效文件
    }
