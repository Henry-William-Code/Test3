 ...
 * 开奖历史
 */
public class DrawHistoryActivity extends AbsActivity {
    ...
    private void initView() {
        ...
        setTitle(WordUtil.getString(R.string.draw_history));
    ...
    public void getData(final boolean isRefresh) {
        LiveHttpUtil.getOpenLotteryHistory(mPage, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                ...
                List<DrawHistoryBean> lists = JSON.parseArray(Arrays.toString(info), DrawHistoryBean.class);
