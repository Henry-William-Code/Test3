 ...
 * 修改手机号
 */
public class ModifyPhoneNumActivity extends AbsActivity {
    ...
    protected void main() {
        super.main();
        setTitle(WordUtil.getString(R.string.modify_phone_number));
        EventBus.getDefault().register(this);

        mTvPhoneNum = findViewById(R.id.tv_phone_num);
        String phoneNum = getIntent().getStringExtra("phoneNum");
        mTvPhoneNum.setText(WordUtil.getString(R.string.bound_mobile_phone_number, phoneNum));
        findViewById(R.id.btn_change_phone_num).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void event(ModifyPhoneNum phoneNum) {
        mTvPhoneNum.setText(WordUtil.getString(R.string.bound_mobile_phone_number, phoneNum.getPhoneNum()));
    }
