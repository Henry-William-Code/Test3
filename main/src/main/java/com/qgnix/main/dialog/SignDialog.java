...
import com.qgnix.main.custom.BonusItemView;
 ...
 * 签到dialog
 */
public class SignDialog extends BaseCustomDialog implements View.OnClickListener {
    ...
    private void getBonus() {
        ...
        MainHttpUtil.getBonus(CommonAppConfig.getInstance().getDeviceId(mContext), new HttpCallback() {
            @Override
