...
import com.qgnix.game.GameConsts;
import com.qgnix.game.R;
import com.qgnix.game.bean.BankerBean;
import com.qgnix.game.bean.GameParam;
import com.qgnix.game.custom.GameBetCoinView;
import com.qgnix.game.custom.PokerView;
import com.qgnix.game.dialog.GameNzLsDialogFragment;
import com.qgnix.game.dialog.GameNzSfDialogFragment;
import com.qgnix.game.dialog.GameNzSzDialogFragment;
import com.qgnix.game.event.GameWindowChangedEvent;
import com.qgnix.game.http.GameHttpConsts;
import com.qgnix.game.http.GameHttpUtil;
import com.qgnix.game.util.GameIconUtil;
import com.qgnix.game.util.GameSoundPool;
...
public class GameNzViewHolder extends AbsGameViewHolder {
    ...
    public GameNzViewHolder(GameParam param, GameSoundPool gameSoundPool, BankerBean bankerBean, String bankerLimitString) {
        ...
        mBankerAvatar = bankerView.findViewById(R.id.avatar);
        mBankerName = bankerView.findViewById(R.id.name);
        mBankerCoin = bankerView.findViewById(R.id.coin);
        mBankerPokerView = bankerView.findViewById(R.id.pokerView);
        mBankerResult = bankerView.findViewById(R.id.result);
