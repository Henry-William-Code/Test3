package com.faceunity.beautybox;
...
public class BeautyBox extends BaseBeautyBox {
    ...
    public BeautyBox(Context context,  AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeautyBox(Context context,  AttributeSet attrs, int defStyleAttr) {
