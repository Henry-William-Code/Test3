...
public class ConfirmDialogFragment extends BaseDialogFragment {
     ...
     * @return
     */
    public static ConfirmDialogFragment newInstance(String title, OnClickListener onClickListener) {
    ...
    public static ConfirmDialogFragment newInstance(String title, String confirmText,
                                                    String cancelText, OnClickListener onClickListener) {
        ConfirmDialogFragment fragment = new ConfirmDialogFragment();
        fragment.mOnClickListener = onClickListener;
        Bundle bundle = new Bundle();
        bundle.putString(TITLE, title);
    ...
    @Override
    protected View createDialogView(LayoutInflater inflater,  ViewGroup container) {
