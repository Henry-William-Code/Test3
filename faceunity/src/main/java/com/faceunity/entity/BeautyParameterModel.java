...
public abstract class BeautyParameterModel {
    ...
    public static boolean checkIfFaceShapeChanged() {
        ...
        return Float.compare(sMicroSmile, FACE_SHAPE_DEFAULT_PARAMS.get(R.id.beauty_box_smile)) != 0;
    }
    ...
    public static boolean checkIfFaceSkinChanged() {
        ...
        return Float.compare(sBlurLevel, FACE_SKIN_DEFAULT_PARAMS.get(R.id.beauty_box_blur_level)) != 0;
    }
