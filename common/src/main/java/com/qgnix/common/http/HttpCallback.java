...
public abstract class HttpCallback extends AbsCallback<JsonBean> {
    ...
    public void onError(Response<JsonBean> response) {
        ...
        if ((code == -1 && t instanceof UnknownHostException)||(code == 502 && t instanceof HttpException)) {
            //host异常, 修改请求host
        ...
        if (t instanceof SocketTimeoutException || t instanceof ConnectException || t instanceof UnknownServiceException || t instanceof SocketException) {
