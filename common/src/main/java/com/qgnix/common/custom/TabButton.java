...
public class TabButton extends LinearLayout {
    ...
    public TabButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = ta.getColor(R.styleable.TabButton_tbn_text_color, 0xff000000);
        mSelectTextColor = ta.getColor(R.styleable.TabButton_tbn_select_text_color, 0xFD5B6C00);
