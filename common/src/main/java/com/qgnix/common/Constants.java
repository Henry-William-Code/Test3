...
public class Constants {
    ...
    public static final String DIAMONDS = WordUtil.getString(R.string.diamond);
    public static final String VOTES = WordUtil.getString(R.string.Show_ticket);
    public static final String PAY_ALI_NOT_ENABLE = WordUtil.getString(R.string.Alipay_is_not_connected);
    public static final String PAY_WX_NOT_ENABLE = WordUtil.getString(R.string.WeChat_Pay_is_not_connected);
    public static final String PAY_ALL_NOT_ENABLE = WordUtil.getString(R.string.No_payment);
    ...
    public static final int LIVE_FUNC_VIBRATING_EGG = 2009;//跳蛋
    //socket
    public static final String SOCKET_CONN = "conn"; //建立连接
    public static final String SOCKET_BROADCAST = "broadcastingListen"; //客户端监听服务端发来的广播
    public static final String SOCKET_CP_BROADCAST = "cpBroadcastListen"; //客户端监听服务端彩票发来的广播, 彩票开奖时间通知-通知消息
    public static final String SOCKET_SEND = "broadcast";   //客户端发出广播到服务端 - 服务端进一步处理
    public static final String SOCKET_STOP_PLAY = "stopplay";//超管关闭直播间
    public static final String SOCKET_STOP_PLAY_AFTER_EXAM = "stopplay_after_exam_live_issue";//服务端检测到直播流有问题 提示下播
    ...
    public static final String SOCKET_USER_LIST_NOT = "UserListNot";//用户列表
    //游戏socket
    ...
    // 开奖时间
    public static final int SOCKET_CP_WHAT_BROADCAST = 3;
    //socket 用户类型
