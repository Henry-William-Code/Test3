...
import com.tencent.liteav.superplayer.ui.view.VideoProgressLayout;
import com.tencent.liteav.superplayer.ui.view.VolumeBrightnessProgressLayout;
...
public class WindowPlayer extends AbsPlayer implements View.OnClickListener,
     ...
     * @param isVisible
     */
    public void toggleLayoutTopView(boolean isVisible) {
        mLayoutTop.setVisibility(isVisible?View.VISIBLE:View.GONE);
    }
}
